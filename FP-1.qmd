...
In this section, we will be sharing several data visualizations (both tables and figures) that help analyze the data.
...
```{r}
ggplot(foodDF, aes(x = foodDF[[44]], fill = foodDF[[23]])) + 
...
ratings_data$Household.Income <- factor(ratings_data$Household_Income, levels = c(
